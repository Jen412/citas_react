...
const Formulario = ({pacientes,setPacientes,paciente,setPaciente}) => {
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-3">
      ...
      <p className="text-lg mt-5 text-center mb-10">Añade Pacientes y {''} <span className="font-black text-indigo-600 text-lg">Administralos</span></p>

      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-10 mx-5">
        {error && <Error><p>Todos los campos son oblogatorios</p></Error>}
        <div className="mb-5">
        ...
        <div className="mb-5">
          ...
          <input className="border-2 w-full p-2 mt-2 rounded-md" type="date" id="alta" value={fecha} onChange={(e)=>setFecha(e.target.value)}/>
        </div>
        <div className="mb-5">
